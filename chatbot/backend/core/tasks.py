...
def update_user_profile_task(session_id, user_message):
    ...
    - peh1 = probability (0 to 1) that the user is Action-Based(prefers lists, steps, directness, shorter, more concise response)
    - peh2 = probability (0 to 1) that the user is Relationship-Based (prefers conversation, questions, narrative, detailed response)
